...
document.getElementById("buscar-coti").addEventListener("click",(ev)=>{
    console.log("modifica esta cotizacion");
...
async function buscar_cotizacion_modificar(){
    ...
    try{
        ...
        for(let indice in paso3){
            ...
            parrafo1.textContent=paso3[indice][2];
            ...
            enlace.textContent=paso3[indice][3];
            let titulo=document.createElement('h3');
            titulo.appendChild(enlace);
            let parrafo2=document.createElement('p');
            parrafo2.className="ml-4";
            parrafo2.textContent=`$${paso3[indice][4]}`;
            ...
            parrafo3.textContent=paso3[indice][5];
            ...
            boton1.textContent=`Cant. ${paso3[indice][6]}`;
            ...
            parrafo5.textContent=`Dscto% ${paso3[indice][8]}`;
        ...
        boton_prom.textContent="Agregar Productos";
