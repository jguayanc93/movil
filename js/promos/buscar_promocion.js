...
async function buscar_promocion_cotizacion(){
    ...
    try{
        ...
        cuerpo1.textContent="Lista Promociones";
        ...
        for(let indice in paso3){
            ...
            boton2.id=`seleccion-item-${paso3[indice][9]}`;
            boton2.type="button";
            boton2.className="font-medium text-indigo-600 hover:text-indigo-500";
            boton2.textContent=`Eliminar ${paso3[indice][9]}`;
            boton2.addEventListener('click',()=>{
                document.getElementById(`seleccion-item-${paso3[indice][9]}`).textContent="seleccionado";
                document.getElementById(`seleccion-item-${paso3[indice][9]}`).disabled=true;
                recojedor_promocion(paso3[indice][3],paso3[indice][9],paso3[indice][14])
            })
        ...
        parrafo6.textContent="Listado de promociones marcadas.";
        ...
        boton_prom.textContent="Mostrar Promociones";
